...
public class NotificationController {
  ...
  @GetMapping("/unread")
  public EnvelopeResponse<GetNotificationBoxCheckResDto> checkNotificationBox() {

    return EnvelopeResponse.<GetNotificationBoxCheckResDto>builder()
        .data(notificationService.checkNotificationBox())
        .build();
