package com.a606.jansori.global.S3.Service;

import com.a606.jansori.global.S3.Domain.AwsS3;
...
public class AwsS3Service {
  ...
  public Optional<File> convertMultipartFileToFile(MultipartFile multipartFile) throws IOException {
    ...
    try {
      ...
      File file = new File(tmpDir, generateUniqueFileName(multipartFile.getOriginalFilename()));
